	...
	private Color getCellColor() {
        ...
        switch (value) {
            ...
            case 4:     color = new Color(200, 255, 255);
                        break;
            case 8:     color = new Color(100, 255, 255);
                        break;
            case 16:    color = new Color(0, 200, 255);
                        break;
            case 32:    color = new Color(0, 100, 255);
                        break;
            case 64:    color = new Color(0, 0, 255);
                        break;
            case 128:   color = new Color(150, 0, 255);
                        break;
            case 256:   color = new Color(200, 0, 255);
                        break;
            case 512:   color = new Color(255, 0, 255);
                        break;
            case 1024:  color = new Color(255, 0, 100);
                        break;
